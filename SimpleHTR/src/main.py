...
def validate(model: Model, loader, line_mode: bool, is_train: bool = False) -> Tuple[float, float]:
    """Validates NN."""

    print('Validate NN (Train)' if is_train else 'Validate NN (Val)')
    loader.train_set() if is_train else loader.validation_set() 
